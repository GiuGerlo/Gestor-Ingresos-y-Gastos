            ...
            <div class="modal-body">
                ...
                <form id="addPaymentMethodForm" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="addPaymentMethodIcon" class="form-label">
                                    <i class="fas fa-icons me-1"></i>
                                    Icono
                                </label>
                                <div class="input-group">
                                    <span class="input-group-text">
                                        <span id="addPaymentMethodIconPreview">
                                            <i class="fas fa-credit-card"></i>
                                        </span>
                                    </span>
                                    <input type="text" class="form-control" id="addPaymentMethodIcon" name="icono" 
                                           value="fas fa-credit-card" readonly>
                                    <button type="button" class="btn btn-outline-primary" onclick="openIconPicker('addPaymentMethodIcon', 'addPaymentMethodIconPreview', document.getElementById('addPaymentMethodIcon').value)">
